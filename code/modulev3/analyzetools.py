...
from modulev3.stathelper import check_raw_gc, get_collective_optimal_lag
    ...
    for td in range(1, max_tpd + 1):
        ...
        for src_indice in range(number_of_points):
            ...
            for dst_indice in tp_indices[src_indice]:
                ...
                granger_causality_mag, granger_causality_pvalue = check_raw_gc(src_indice, dst_indice, tp_indices, context.cells_response_curve, optimal_lag)                
